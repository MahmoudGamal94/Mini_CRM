                    ...
                    <div class="bg-gray-200 bg-opacity-25 border-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="">Edit Employee</a></div>
                            </div>
                            <div class="container mt-4">
                                @include('alert_message')
                                <form method="post" action="{{'/employee/update/'.$data->emp_id}}">
                                    @csrf
                                    ...
                                    <div class="form-outline mb-2 col-8 fs-6">
                                        <select class="select2 form-control" name="company">
                                            {{$data->company}}
                                                <option value="{{$data->company}}" selected >{{$data->get_comp_name->name}}</option>
